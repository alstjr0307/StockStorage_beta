...
class AllSearch extends StatefulWidget {
  final String search;
  const AllSearch({Key key, this.search}) : super(key: key); //index = 게시물 번호
...
class _AllSearchState extends State<AllSearch>
  ...
  void _getMoreData(int index) async {
    ...
    if (!isLoading) {
      ...
      var url = "http://13.125.62.90/api/v1/BlogPosts/?multisearch=${widget.search}&page=" +
          (index + 1).toString();
      print(url);
